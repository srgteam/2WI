                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(onPressed:(){
                          ...
                          Navigator.of(context).pushReplacementNamed('/first');
                            ...
                            mainAxisAlignment:MainAxisAlignment.start,
                          children: [
                            Icon(Icons.home_outlined,color:Colors.red,size:50,),
                            Padding(
                    ...
                    ,
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(onPressed:() async {
                          ...
                          var result = await Process.run('systemctl', ['start','agl-app@settings.service']);
                        ...
                        child: ElevatedButton(onPressed:() async {
                         ...
                         // Navigator.push(context, MaterialPageRoute(builder:(context)=>bluetooth()));
                          ...
                          children: [
                            ...
                            Text("MediaPlayer",textAlign:TextAlign.start,style:TextStyle(color:Colors.white,fontSize:40,fontWeight:FontWeight.bold),),
                          ],
